...
- `references/patterns-learned.md` — project-specific patterns discovered during development
- `references/quality-checklist.md` — expanded checklist for code review